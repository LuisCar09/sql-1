...
-- Tu respuesta aquí
SELECT lenguaje,LENGTH(lenguaje) as longitud FROM usuarios_lenguajes GROUP BY lenguaje ORDER BY MAX(longitud) DESC LIMIT 1

-- Ejercicio 23: Seleccionar los usuarios y mostrar la concatenación de su nombre y apellido.
-- Tu respuesta aquí
SELECT CONCAT(nombre,'',apellido) as nombreyapellido FROM usuarios_lenguajes;

-- Ejercicio 24: Contar cuántos lenguajes diferentes conocen los usuarios mayores de 25 años. 
-- Tu respuesta aquí

SELECT nombre,count(lenguaje) AS cantidad_lenguajes FROM usuarios_lenguajes WHERE edad > 25 GROUP BY nombre;
...
-- Tu respuesta aquí
SELECT lenguaje,LENGTH(lenguaje) as longitud FROM usuarios_lenguajes WHERE EDAD < 30 GROUP BY lenguaje ORDER BY longitud DESC LIMIT 1
...
-- Tu respuesta aquí
SELECT nombre,LENGTH(lenguaje) as lenguajeCantidad FROM usuarios_lenguajes WHERE lenguaje LIKE 'J%' GROUP BY nombre,lenguajeCantidad ORDER BY lenguajeCantidad ASC LIMIT 1; 

-- Ejercicio 30: Encontrar el usuario con edad mayor a 30 y que sabe el lenguaje con menos caracteres.
-- Tu respuesta aquí
SELECT nombre,LENGTH(lenguaje) as longitud FROM usuarios_lenguajes WHERE edad > 30 GROUP BY nombre,longitud ORDER BY longitud ASC LIMIT 1;
...
SELECT COUNT(nombre) FROM usuarios_lenguajes WHERE lenguaje IS NOT NULL AND edad BETWEEN 20 AND 30;
...
SELECT nombre,edad,promedio FROM usuarios_lenguajes CROOS JOIN(SELECT AVG(edad) AS promedio FROM usuarios_lenguajes) AS subquery;
-- Ejercicio 36: Contar cuántos usuarios tienen un lenguaje asociado que contiene la palabra 'Script'.
-- Tu respuesta aquí
SELECT nombre FROM usuarios_lenguajes WHERE lenguaje LIKE '%Script%'
...
-- Tu respuesta aquí
SELECT *  FROM usuarios_lenguajes CROOS JOIN(SELECT SUM(edad) as edades FROM usuarios_lenguajes) as subquery;
